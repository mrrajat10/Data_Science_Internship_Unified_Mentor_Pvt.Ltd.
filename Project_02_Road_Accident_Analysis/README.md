...
- Vulnerable groups: Pedestrians and two-wheeler riders.
...
```bash
git clone https://github.com/your-username/road-accident-mortality-2020.git
cd road-accident-mortality-2020
