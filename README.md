...
2.🚦 Road Accident Analysis (India, 2020) → EDA on 9,547 records; heatmaps & bar plots revealed overspeeding, driver fault, and city-specific risk zones.<br>
3.💬 Customer Satisfaction Prediction → 8,400+ support tickets analyzed; engineered behavioral features; Random Forest hit 100% accuracy under rule-based labels.<br>
